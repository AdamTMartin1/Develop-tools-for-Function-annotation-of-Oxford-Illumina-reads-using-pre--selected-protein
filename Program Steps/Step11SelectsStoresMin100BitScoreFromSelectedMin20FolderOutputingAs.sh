...
for FILE in $(ls *.txt); do
	echo $FILE
	output=/home/ws152103/Documents/Project/Allumina/$Folder/fasta/AligmentEditedBlast/TextFiles/Min20Files/Min100Files/$FILE.Min100	
